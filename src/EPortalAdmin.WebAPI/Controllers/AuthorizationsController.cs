...
namespace EPortalAdmin.WebAPI.Controllers
{
    ...
    [ApiController]
    public class AuthorizationsController(IConfiguration configuration) : BaseController
    {
        private readonly WebApiConfiguration _webApiConfiguration = configuration.GetSection(WebApiConfiguration.AppSettingsKey).Get<WebApiConfiguration>()
